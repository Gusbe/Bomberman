...
Grid.prototype.configureBoard = function (){
  ...
  this.board[1] = ['W','P','X','S','X','X','X','X','S','X','W'];
  this.board[2] = ['W','X','W','X','W','X','W','X','W','S','W'];
  this.board[3] = ['W','S','X','X','X','X','X','S','X','X','W'];
  this.board[4] = ['W','X','W','X','W','X','W','S','W','X','W'];
  this.board[5] = ['W','S','X','S','X','X','X','S','X','S','W'];
  ...
  this.board[11] = ['W','S','X','S','X','S','X','X','X','X','W'];
  this.board[12] = ['W','X','W','S','W','S','W','S','W','S','W'];
  this.board[13] = ['W','X','S','X','S','X','X','S','X','S','W'];
